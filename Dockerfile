...
RUN apt update && \
  apt install -y git sqlite3 python2.7 python-virtualenv python3.5 python-pip python3-pip python3-virtualenv ffmpeg bash telnet supervisor gettext-base libffi-dev && \
